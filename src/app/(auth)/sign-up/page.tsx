      ...
      <div className="bg-gray-800 bg-opacity-80 rounded-lg shadow-lg p-6 sm:p-10 flex flex-col lg:flex-row w-full sm:max-w-md md:max-w-lg lg:max-w-6xl">
        ...
        <div className="w-full lg:w-[60%] p-6 lg:p-10">
          ...
          <div className="flex justify-center space-x-4 mb-8">
            <button
              ...
              className={`py-2 px-4 rounded-full ${
                isPhysicalPerson ? "bg-green-600 text-white" : "bg-gray-700 text-gray-300"
              }`}
            >
              Pessoa Física
            </button>
          ...
          <button
            ...
            className="w-full mt-8 bg-green-600 hover:bg-green-700 text-white py-3 px-6 sm:px-8 rounded-full transition-transform duration-300 ease-in-out shadow-lg"
          >
